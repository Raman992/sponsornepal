...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-primary-foreground shadow-lg shadow-primary/25 hover:bg-primary/90 hover:shadow-xl hover:shadow-primary/20",
        destructive:
        ...
        "gradient-vibrant":
          "bg-gradient-to-r from-[#ef6c4a] via-[#ffd23f] to-[#2ba8a2] text-white shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/40 hover:brightness-105",
        glass:
          "glass text-foreground hover:bg-white/10 dark:hover:bg-white/5 border border-white/20",
        subtle:
          "bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground",
        glow:
          "bg-primary text-primary-foreground shadow-[0_0_20px_-5px_rgba(0,0,0,0.3)] shadow-primary/50 hover:shadow-[0_0_30px_-5px_rgba(0,0,0,0.4)] hover:shadow-primary/60",
      },
      size: {
