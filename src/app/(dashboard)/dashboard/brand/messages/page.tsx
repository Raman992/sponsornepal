  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">Your conversations with creators</p>
      </div>
      ...
      {conversations.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground max-w-sm">
            Start a conversation by reaching out to creators or responding to their messages.
          </p>
        </div>
      ) : (
        <div className="space-y-3">
          {conversations.map((conversation) => (
            <Link
              key={conversation.id}
              href={`/dashboard/brand/messages/${conversation.id}`}
            >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <h3 className="font-semibold truncate">
                        {conversation.otherUser?.full_name || "Creator"}
                      </h3>
